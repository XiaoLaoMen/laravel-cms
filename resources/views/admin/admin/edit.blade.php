...
@section('contents')
    <form class="layui-form" method="post" action="{{ url('backstage/admin/update',['id'=>$list['id']]) }}">
        @csrf
        <div class="layui-form-item">
            <label for="name" class="layui-form-label">
                <span class="x-red">*</span>昵称</label>
            <div class="layui-input-inline">
                <input type="text" name="name" value="{{ $list['name'] }}" placeholder="请输入昵称" autocomplete="off" class="layui-input" lay-verify="name">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="email" value="{{ $list['email'] }}" lay-verify="email" placeholder="xxx@xx.com"  autocomplete="off" class="layui-input"></div>
            <div class="layui-form-mid layui-word-aux">
            ...
            function() {
                ...
                form.verify({
                    ...
                    password_confirmation: function(value) {
                        ...
                        var ret = /^.*(?=.{6,16})(?=.*\d)(?=.*[A-Z])(?=.*[a-z]).*$/;
                        if(password != '' && !ret.test(password)){
                            return '客官,密码格式不正确';
                        }
                    }
                });
                ...
                formSelects.value('role_id', [{{ $roles }}]);
            });</script>
@endsection