            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                <div class="row content">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <h3><a href="" class="title">你猜呢</a></h3>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <ul class="row">
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-4 hidden-xs">
                                <figure class="b-oa-pic b-style1">
                                    <a href="" target="_blank">
                                        <img src="https://baijunyao.com/uploads/article/20190505/5ccf0710e7f60.png" alt="" title="">
                                    </a>
                                    <figcaption>
                ...
                <div class="row page-list">
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8 b-page text-center">
                        <ul class="pagination">
                            <li class="disabled"><span>上一页</span></li>
                            <li class="active"><span>1</span></li>
                            <li><a href="https://baijunyao.com?page=18">18</a></li>
